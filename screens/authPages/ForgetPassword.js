    ...
    return (
        <View style={{paddingTop: height * 0.05}} className=' flex-1 px-[5vh] bg-white'>
            ...
            <View style={{paddingTop: height * 0.1}} className='items-center'>
                <Text style={{ fontFamily: 'Poppins-Bold' }} className='text-3xl text-[#3D4A7A]'>Forgot Password?</Text>
                <Text style={{ fontFamily: 'Poppins-Regular' }} className={`text-neutral-400 text-lg text-center`} >Forgot your password, Don't worry we got you</Text>
                ...
                <View style={{ width: width * 0.9, height: height * 0.3 }} className='items-center mt-10 text-white bg-white rounded-xl '>
                    ...
                    <TouchableOpacity  className='rounded-full ' style={{ width: width * 0.8, height: height * 0.06, marginTop: height * 0.24 }}>
                        <LinearGradient
                            ...
                            <Text className='text-lg' style={{ color: 'white', fontFamily: 'Poppins-Bold' }}>Get OTP</Text>
                        </LinearGradient>
                    </TouchableOpacity>
                </View>
            </View>
